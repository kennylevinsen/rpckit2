...
func templatesGoRpckit_boilerplateGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/go/rpckit_boilerplate.go.tmpl", size: 18381, mode: os.FileMode(436), modTime: time.Unix(1538749976, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
